...
enum LID_TYPE{AVIA = 1, VELO16, OUST64, HES32, V_M1600}; //{1, 2, 3}
...
POINT_CLOUD_REGISTER_POINT_STRUCT(v_m1600::Point,
    (float, x, x)
    (float, y, y)
    (float, z, z)
...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void v_m1600_handler(const sensor_msgs::PointCloud2::ConstPtr &msg);
